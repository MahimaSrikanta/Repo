...
var mergeSort = function(array) {
  // Your code here.
    ...
    function mergeSorting (array,  left, right) {
        if(right > left) {
            var middle = Math.floor(left+right/2);
            mergeSorting(array,left, middle)  //dividing left side of the array
            mergeSorting(array,middle+1, right) // dividing right of the array
